桑基图 用什么画图
Base directory for this skill: /private/tmp/claude-501/bundled-skills/2.1.233/032aa39e7c9665521afcabc953ad3cf2/dataviz
# Data Visualization
...
## User Request
用户询问桑基图（Sankey diagram）用什么工具/库画图，需要工具选型建议
最佳用什么。让 ai 写
